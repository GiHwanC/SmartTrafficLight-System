...
| 이름 | 역할 | 상세 기여 |
|------|-------|---------------|
| **김기환 (팀장)** | 시스템 설계 & 펌웨어 개발 | <ul><li>프로젝트 전체 구조 및 기능 기획</li><li>STM32F411 기반 **펌웨어 전체 개발 (LED, LCD, RFID, 서보모터 제어)**</li><li>RFID UID 기반 노약자 판단 알고리즘 구현</li><li>보행/차량 신호 제어 로직 및 타이머 구현</li><li>Pinmap 설계, 회로 구성, 플로우차트 설계</li><li>GitHub 문서화 및 발표 자료 구성</li></ul> |
| **김경민 (팀원)** | 하드웨어 조립 및 테스트 | <ul><li>교차로 모형 제작</li><li>배선 정리 및 서보모터 고정</li><li>센서 동작 테스트 및 모듈 배선 점검</li><li>LCD/LED 노출 부분 제작</li></ul> |
